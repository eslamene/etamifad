						...
						<div class="col-md-12">
							...
							<div class="box box-solid box-primary" id="first_div">
								...
								<div class="box-header">
									...
									<a class="btn btn-lg btn-flat" href="<?php echo $_SERVER['PHP_SELF'].'?Report=warehouse-01&View='.$_REQUEST['View']; ?>" target="_self">
													  ...
													  while ($row = $Result->fetch_assoc())
														{
																...
																echo 		'<td><input type="number" value="'.$row['Delivery_Available'].'" name="Delivery_Available[]" class="form-control" step="0.100" min="0" max="'.$row['Quantity'].'"/></td>';
