						...
						<script language="javascript">
							document.title = "Report - Sales Forecast - Customer/Unit | Eta Mifad";
						</script>
						<!-- /*******/ Page Name /*******/ -->
						...
						<div class="col-md-12">
							...
							<div class="box box-solid box-primary" id="first_div">
								...
								<div class="box-header">
									...
									<h3 class="box-title">Sales Forecast Year <?php echo $_REQUEST['Year']; ?> - Customer/Unit</h3>
							...
							<div class="box box-solid box-warning">
								...
								<div class="box-header">
									...
									<h3 class="box-title">Forecasted in Details - Customer/Unit</h3>
									<a class="btn btn-lg btn-flat" href="<?php echo str_replace("unit","package",$_SERVER['REQUEST_URI']); ?>" target="_self">
										<i class="glyphicon glyphicon-transfer"></i>&ensp;<small><strong> to Package</strong></small>
									</a>
								</div>
									...
									<table id="SalesForecastCustomer" class="table table-bordered">
										<thead>
											<tr>
												...
												<th>Dec Value</th>
												<th>&Sigma; Qty Q4</th>
												<th>&Sigma; Value Q4</th><th>&Sigma; Total Qty / Year</th>
												<th>&Sigma; Total Value / Year</th>
											</tr>
										</thead>
										<tbody>
							...
							<div class="box box-solid box-success">
								...
								<div class="box-header">
									...
									<h3 class="box-title">Product Forecast Year - Customer/Unit</h3>
								</div>
								<div class="box-body chart-responsive">
									<?php $Chart = "./forms/chart/chart_customer_unit.php"; ?>
