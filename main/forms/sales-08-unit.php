						...
						<script language="javascript">
							document.title = "Report - Sales Forecast - Representative/Unit | Eta Mifad";
						</script>
						<!-- /*******/ Page Name /*******/ -->
						...
						<div class="col-md-12">
							...
							<div class="box box-solid box-primary" id="first_div">
								...
								<div class="box-header">
									...
									<h3 class="box-title">Sales Forecast Year <?php echo $_REQUEST['Year']; ?> - Representative/Unit</h3>
														...
														<?php 
															...
															if ($Result = mysqli_query($MySQLConnection,$Query1))
															{
															  ...
															  while ($row = $Result->fetch_assoc())
																{
																	echo 	'<tr>';
																	echo 		'<td>'.'<a href="'.$_SERVER['PHP_SELF'].'?Report='.$_REQUEST['Report'].'&Year='.$_REQUEST['Year'].'&Rep='.$row['Representative_NO'].'&RepName='.$row['Representative_Name'].'&Company='.$row['Company'].'&Collapse">'.$row['Representative_Name'].'</a></td>';
																	echo		'<td>'.$row['Company'].'</td>';
																	echo 		'<td class="text-purple">'.number_format($row['SUM_Q_01'],2).'</td>';
																	echo 		'<td class="text-yellow">'.$Currency_Symbol.number_format($row['SUM_Q_V_01'],2).'</td>';
																	echo 		'<td class="text-purple">'.number_format($row['SUM_Q_02'],2).'</td>';
																	echo 		'<td class="text-yellow">'.$Currency_Symbol.number_format($row['SUM_Q_V_02'],2).'</td>';
																	echo 		'<td class="text-purple">'.number_format($row['SUM_Q_03'],2).'</td>';
																	echo 		'<td class="text-yellow">'.$Currency_Symbol.number_format($row['SUM_Q_V_03'],2).'</td>';
																	echo 		'<td class="text-purple">'.number_format($row['SUM_Q_04'],2).'</td>';
																	echo 		'<td class="text-yellow">'.$Currency_Symbol.number_format($row['SUM_Q_V_04'],2).'</td>';
							...
							<div class="box box-solid box-warning">
								...
								<div class="box-header">
									...
									<h3 class="box-title">Forecasted in Details - Representative/Unit</h3>
									<a class="btn btn-lg btn-flat" href="<?php echo str_replace("unit","package",$_SERVER['REQUEST_URI']); ?>" target="_self">
										<i class="glyphicon glyphicon-transfer"></i>&ensp;<small><strong> to Package</strong></small>
									</a>
								</div>
							...
							<div class="box box-solid box-success">
								...
								<div class="box-header">
									...
									<h3 class="box-title">Product Forecast Year - Representative/Unit</h3>
								</div>
								<div class="box-body chart-responsive">
									<?php $Chart = "./forms/chart/chart_rep_unit.php"; ?>
