						...
						<script language="javascript">
							document.title = "Report - Sales Forecast - Product/Package | Eta Mifad";
						</script>
						<!-- /*******/ Page Name /*******/ -->
						...
						<div class="col-md-12">
							...
							<div class="box box-solid box-primary" id="first_div">
								...
								<div class="box-header">
									...
									<h3 class="box-title">Sales Forecast Year <?php echo $_REQUEST['Year']; ?> - Product/Package</h3>
							...
							<div class="box box-solid box-warning">
								...
								<div class="box-header">
									...
									<h3 class="box-title">Forecasted in Details - Product/Package</h3>
									<a class="btn btn-lg btn-flat" href="<?php echo str_replace("package","unit",$_SERVER['REQUEST_URI']); ?>" target="_self">
										<i class="glyphicon glyphicon-transfer"></i>&ensp;<small><strong> to Unit</strong></small>
									</a>
								</div>
											...
											<?php 
												...
												if ($Result = mysqli_query($MySQLConnection,$Query2))
												{
												  ...
												  while ($row = $Result->fetch_assoc())
													{
														echo 	'<tr>';
														echo 		'<td>'.'<a href="'.$_SERVER['PHP_SELF'].'?Report='.str_replace("-07","-09",$_REQUEST['Report']).'&Year='.$_REQUEST['Year'].'&CustomerNO='.$row['Customer_NO'].'&CustomerName='.$row['Customer_Name'].'&Company='.$row['Company'].'&Collapse">'.$row['Customer_NO'].'</a></td>';
														echo 		'<td>'.'<a href="'.$_SERVER['PHP_SELF'].'?Report='.str_replace("-07","-09",$_REQUEST['Report']).'&Year='.$_REQUEST['Year'].'&CustomerNO='.$row['Customer_NO'].'&CustomerName='.$row['Customer_Name'].'&Company='.$row['Company'].'&Collapse">'.$row['Customer_Name'].'</a></td>';
														echo 		'<td>'.'<a href="'.$_SERVER['PHP_SELF'].'?Report='.str_replace("-07","-08",$_REQUEST['Report']).'&Year='.$_REQUEST['Year'].'&Rep='.$row['Representative_NO'].'&RepName='.$row['Representative_Name'].'&Company='.$row['Company'].'&Collapse">'.$row['Representative_Name'].'</a></td>';
														echo 		'<td>'.number_format($row['SUM_M_01'],2).'</td>';
														echo 		'<td class="text-yellow">'.$Currency_Symbol.number_format($row['SUM_M_V_01'],2).'</td>';
														echo 		'<td>'.number_format($row['SUM_M_02'],2).'</td>';
														echo 		'<td class="text-yellow">'.$Currency_Symbol.number_format($row['SUM_M_V_02'],2).'</td>';
							...
							<div class="box box-solid box-danger">
								...
								<div class="box-header">
									...
									<h3 class="box-title">Product Forecast Year - Product/Package</h3>
								</div>
								<div class="box-body chart-responsive">
									<?php $Chart = "./forms/chart/chart_product_package.php"; ?>
