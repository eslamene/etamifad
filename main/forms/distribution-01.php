						...
						<div class="col-md-12">
							...
							<div class="box box-solid box-warning" id="first_div">
								...
								<div class="box-header">
									...
									<a class="btn btn-lg btn-flat" href="<?php echo $_SERVER['PHP_SELF'].'?Report=distribution-03&View=Planned'; ?>" target="_self">
										<i class="fa fa-tasks"></i>&ensp;<small><strong> Tasked</strong></small>
									</a>
								</div>
								<!-- /.box-header -->
								<div class="box-body">
											  ...
											  while ($row = $Result->fetch_assoc())
												{
													...
													echo 		'<td id="sandbox-container"><input type="text" value="'.$row['Delivery_Date_Start'].'" name="Delivery_Date_Start[]" class="form-control" data-inputmask="\'alias\': \'yyyy-mm-dd\'" data-mask  Required/></td>';
													echo 		'<td id="sandbox-container"><input type="text" value="'.$row['Delivery_Date_End'].'" name="Delivery_Date_End[]" class="form-control" data-inputmask="\'alias\': \'yyyy-mm-dd\'" data-mask/></td>';
													echo 	'</tr>';
